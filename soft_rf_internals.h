...
{
    0x0d,  0x0e,  0x13, 0x15, 0x16, 0x19, 0x1a, 0x1c, // 001101, 001110, 010011,
...
converted_sequence* convert_timer_sequence(bit_time* bt, timer_receive_sequence* timers_sequence, uint16_t* length, uint16_t* data_iterator); // TODO
