...
converted_sequence* convert_timer_sequence(bit_time* bt, TIM_sequence* timers_sequence, uint16_t* length, uint16_t* data_iterator); // Ok
...
void copy_intro_start_seq_to_transmit_buffer(uint16_t *output_timer_buffer, bit_time *bt, uint8_t *buffer_iterator);  // - ok ?
