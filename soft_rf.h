...
typedef struct
{
    ...
    uint16_t receive_sequence_[MAX_SEQUENCE_ITERATOR]; //{0,} // принимаемая последовательность
// (не переведенная) (304 бита (19*16бит) округл до 20)
    uint16_t sequence_iterator_; // 0
